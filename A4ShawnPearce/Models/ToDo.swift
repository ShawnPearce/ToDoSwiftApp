...
extension Todo {
    ...
    //see documentation: //see documentation https://developer.apple.com/documentation/foundation/calendar
    ...
    static var todoList: [Todo] = [
        ...
        Todo(id: 3, title: "Pay bills", priorityLevel: .critical, deadLine: Calendar.current.date(from: DateComponents(year: 2025, month: 8, day: 20, hour: 17, minute: 0))!, description: "Pay all the bills, water, gas, internet, phone, etc.DO NOT FORGET!!!!!!!!!")
]
}
